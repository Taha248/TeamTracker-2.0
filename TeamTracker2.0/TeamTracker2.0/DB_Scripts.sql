...
ALTER TABLE USER ADD AccType VARCHAR(40)

ALTER TABLE USER ADD CREATED_BY DATETIME

ALTER TABLE USER ADD CREATED_ON DATETIME

ALTER TABLE USER ADD COLUMN IS_ACTIVE INT(1) DEFAULT 0

ALTER TABLE USER ADD COLUMN PERMISSIONS LONGTEXT	

ALTER TABLE `user` ADD COLUMN MODIFIED_BY INT(10);

ALTER TABLE `user` ADD COLUMN MODIFIED_ON DATE;

ALTER TABLE `USER` MODIFY COLUMN CREATED_BY INT(10);
